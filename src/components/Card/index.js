    ...
    return (
        <div className={styles.card}>
            ...
            >
                ...
                {onFavorite && <img src={isFavorite ? "/img/heart-liked.svg" : "/img/heart-unliked.svg"} alt="Unliked" onClick={onIsFavoriteClick} />}
            </div>
                ...
                <div className="d-flex justify-between align-center">
                    ...
                    {onPlus && <img className={styles.plus} onClick={onClickPlus} src={isItemAdded(id) ? '/img/btn-checked.svg' : '/img/btn-plus.svg'} alt="" />}
                </div></>}
        </div>
    )
}
